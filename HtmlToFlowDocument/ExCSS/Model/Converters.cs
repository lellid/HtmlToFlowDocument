...
namespace ExCSS
{
  internal static class Converters
  {
    ...
    public static readonly IValueConverter IntegerConverter = new StructValueConverter<int>(ValueExtensions.ToInteger);
    public static readonly IValueConverter NaturalIntegerConverter = new StructValueConverter<int>(ValueExtensions.ToNaturalInteger);
    public static readonly IValueConverter WeightIntegerConverter = new StructValueConverter<int>(ValueExtensions.ToWeightInteger);
    public static readonly IValueConverter PositiveIntegerConverter = new StructValueConverter<int>(ValueExtensions.ToPositiveInteger);
    public static readonly IValueConverter BinaryConverter = new StructValueConverter<int>(ValueExtensions.ToBinary);
    public static readonly IValueConverter AngleConverter = new StructValueConverter<Angle>(ValueExtensions.ToAngle);
    public static readonly IValueConverter NumberConverter = new StructValueConverter<float>(ValueExtensions.ToSingle);
    public static readonly IValueConverter NaturalNumberConverter = new StructValueConverter<float>(ValueExtensions.ToNaturalSingle);
    ...
    public static readonly IValueConverter AlphaValueConverter = new StructValueConverter<float>(ValueExtensions.ToAlphaValue);
    ...
    public static readonly IValueConverter MatrixTransformConverter = Construct(() => new FunctionValueConverter(FunctionNames.Matrix, WithArgs(NumberConverter, 6)).Or(
